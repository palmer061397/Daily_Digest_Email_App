...
class DailyDigestGUI:
    ...
    def __init__(self, root):
        ...
        title_label = ttk.Label(self.__root, text = ' Daily Digest',
    ...
    """
    Shutdown the scheduler and save configuration before closing the gui window
    """
    def __shutdown(self):
    	print("Shutting down the scheduler...")
    	self.__scheduler.stop()
    ...
    def __save_config(self, file_path="my_dd_config.json"):
    ...
    """
    def __load_config(self, file_path='my_dd_config.json'):
